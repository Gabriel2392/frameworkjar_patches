...
.method static constructor blacklist <clinit>()V
    ...
    invoke-direct {v3, v4, v5}, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    const/4 v4, 0x0

    new-instance v5, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;

    invoke-direct {v5, v1, v0}, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    const/4 v6, 0x0

    new-instance v7, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;

    invoke-direct {v7, v0, v0}, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    const/4 v8, 0x0

    new-instance v9, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;

    sget-object v10, Lcom/android/internal/org/bouncycastle/math/ec/ECConstants;->ONE:Ljava/math/BigInteger;

    invoke-direct {v9, v10, v0}, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    const/4 v10, 0x0

    filled-new-array/range {v2 .. v10}, [Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;

    move-result-object v2

    sput-object v2, Lcom/android/internal/org/bouncycastle/math/ec/Tnaf;->alpha0:[Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;
    ...
    invoke-direct {v15, v3, v4}, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-direct {v3, v1, v4}, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-direct {v1, v0, v4}, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-direct {v0, v4, v5}, Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    filled-new-array/range {v14 .. v22}, [Lcom/android/internal/org/bouncycastle/math/ec/ZTauElement;
...
.method public static blacklist getSi(IILjava/math/BigInteger;)[Ljava/math/BigInteger;
    ...
    .line 577
    .local v5, "dividend0":Ljava/math/BigInteger;
    sget-object v6, Lcom/android/internal/org/bouncycastle/math/ec/ECConstants;->ONE:Ljava/math/BigInteger;
    ...
    .line 579
    .local v3, "dividend1":Ljava/math/BigInteger;
    filled-new-array {v5, v3}, [Ljava/math/BigInteger;
...
.method public static blacklist getSi(Lcom/android/internal/org/bouncycastle/math/ec/ECCurve$AbstractF2m;)[Ljava/math/BigInteger;
    ...
    .line 559
    .local v7, "dividend0":Ljava/math/BigInteger;
    sget-object v8, Lcom/android/internal/org/bouncycastle/math/ec/ECConstants;->ONE:Ljava/math/BigInteger;
    ...
    .line 561
    .local v5, "dividend1":Ljava/math/BigInteger;
    filled-new-array {v7, v5}, [Ljava/math/BigInteger;
    ...
    .end local v5    # "dividend1":Ljava/math/BigInteger;
    .end local v6    # "ui":[Ljava/math/BigInteger;
    .end local v7    # "dividend0":Ljava/math/BigInteger;
    :cond_1
    new-instance v0, Ljava/lang/IllegalArgumentException;
...
.method public static blacklist getTw(BI)Ljava/math/BigInteger;
    ...
    .line 524
    .local v1, "u1invert":Ljava/math/BigInteger;
