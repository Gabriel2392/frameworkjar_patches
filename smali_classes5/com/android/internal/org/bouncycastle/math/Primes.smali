...
.method private static blacklist implSTRandomPrime(Lcom/android/internal/org/bouncycastle/crypto/Digest;I[B)Lcom/android/internal/org/bouncycastle/math/Primes$STOutput;
    ...
    invoke-virtual {v15, v6}, Ljava/math/BigInteger;->setBit(I)Ljava/math/BigInteger;
    ...
    invoke-virtual {v15, v7}, Ljava/math/BigInteger;->shiftLeft(I)Ljava/math/BigInteger;
    ...
    .end local v4    # "rec":Lcom/android/internal/org/bouncycastle/math/Primes$STOutput;
    .local v17, "rec":Lcom/android/internal/org/bouncycastle/math/Primes$STOutput;
    ...
    .line 543
    .end local v17    # "rec":Lcom/android/internal/org/bouncycastle/math/Primes$STOutput;
    .end local p2    # "x":Ljava/math/BigInteger;
    .restart local v4    # "rec":Lcom/android/internal/org/bouncycastle/math/Primes$STOutput;
    ...
    .end local v4    # "rec":Lcom/android/internal/org/bouncycastle/math/Primes$STOutput;
    .end local v6    # "x":Ljava/math/BigInteger;
    .restart local v17    # "rec":Lcom/android/internal/org/bouncycastle/math/Primes$STOutput;
    .restart local p2    # "x":Ljava/math/BigInteger;
    :goto_2
    add-int/2addr v9, v6

    .line 557
    invoke-static {v7}, Lcom/android/internal/org/bouncycastle/math/Primes;->implHasAnySmallFactors(Ljava/math/BigInteger;)Z
    ...
    invoke-static {v0, v2, v3}, Lcom/android/internal/org/bouncycastle/math/Primes;->hashGen(Lcom/android/internal/org/bouncycastle/crypto/Digest;[BI)Ljava/math/BigInteger;

    move-result-object v3

    .line 560
    .local v3, "a":Ljava/math/BigInteger;
    sget-object v4, Lcom/android/internal/org/bouncycastle/math/Primes;->THREE:Ljava/math/BigInteger;
    ...
    .local v4, "tx2":Ljava/math/BigInteger;
    const/4 v14, 0x0

    .line 565
    invoke-virtual {v3, v4, v7}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v5

    .line 567
    .local v5, "z":Ljava/math/BigInteger;
    ...
    invoke-virtual {v5, v8, v7}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-direct {v0, v7, v2, v9, v15}, Lcom/android/internal/org/bouncycastle/math/Primes$STOutput;-><init>(Ljava/math/BigInteger;[BILcom/android/internal/org/bouncycastle/math/Primes$STOutput-IA;)V
    ...
    .end local v5    # "z":Ljava/math/BigInteger;
    move-object v0, v15
    ...
    .line 574
    .end local v4    # "tx2":Ljava/math/BigInteger;
    ...
    invoke-static {v2, v3}, Lcom/android/internal/org/bouncycastle/math/Primes;->inc([BI)V
